...
const ImageGallery = () => {
  ...
  useEffect(() => {
    fetchImages();
    // Check if welcome banner was closed previously
    ...
    <div className="relative min-h-screen">
      ...
      {loading && (
          <div className="fixed inset-0 z-50 bg-white/30 dark:bg-black/30 backdrop-blur-sm flex items-center justify-center">
            <div className="relative p-8 rounded-xl bg-white/10 backdrop-blur-md border border-white/20">
              <div className="h-24 w-24 rounded-full border-t-4 border-b-4 border-purple-500 animate-spin"></div>
              <div className="absolute top-8 left-8 h-24 w-24 rounded-full border-t-4 border-b-4 border-blue-500 animate-spin" style={{animationDelay: "0.3s"}}></div>
              <div className="absolute top-8 left-8 h-24 w-24 rounded-full border-r-4 border-l-4 border-pink-500 animate-spin" style={{animationDelay: "0.6s"}}></div>
